...
\begin{equation*}
    ...
    = \frac{1}{\sqrt{T}}\begin{bmatrix}
         \sum\limits_{t = 1}^{T}(X_t - \mu)^2 - \mathbb{E}\left[ \tilde{\gamma} \left( 0 \right) \right]\\
         \sum\limits_{t = 1}^{T}\left( {{X_t} - \mu} \right)\left( {{X_{t + h}} - \mu} \right) - \mathbb{E}\left[ \tilde{\gamma} \left( h \right) \right]
        \end{bmatrix} \overset{\mathcal{D}}{\to} 
    \mathcal{N}\left(0, T\var \left(\begin{bmatrix}
         \tilde{\gamma} \left( 0 \right) \\
         \tilde{\gamma} \left( h \right)
