...
```{definition, label="ar_p", name = "Autoregressive Models of Order $p$"}
...
```{definition, label="causal_ar", name = "Causality of AR models"}
...
```{theorem, label="thm_causal_ar", name = "Causality of AR models"}
