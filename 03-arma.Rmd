...
2. Draw $M = \left\lfloor {\frac{N}{\ell}} \right\rfloor$ blocks with replacement
   from these $\left\{S_1, \ldots, S_K\right\}$ blocks and place them in order to form
   $(X_t^*)$. 
...
\[\begin{aligned}
  ...
  {E_t}\left[ {{X_{t + 2}}} \right] &= {E_t}\left[ {{\phi _1}{X_{t + 1}} + {\phi _2}{X_t}} \right] = {E_t}\left[ {{\phi _1}|{\phi _1}{X_t} + {\phi _2}{X_{t - 1}} + {\phi _2}{X_t}} \right] \\
