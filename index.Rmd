...
If you notice any errors, we would be grateful if you would let us know. For that there are two options:

1. If you are familiar with GitHub and know RMarkdown, [make a pull request and fix the issue yourself!](https://github.com/SMAC-Group/TTS) (fastest resolution)
