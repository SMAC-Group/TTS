...
## Proof
In \@ref(appendixa), we give the proof of the asymptotic distribution of the
sample autocorrelation $\hat{\rho}(h)$ that
$$
\sqrt{n}\hat{\rho}(h) \overset{\mathcal{D}}{\to} 
    \mathcal{N}\left(0, 1 \right),
$$
under the data generating process $X_t = W_t + \mu$, where $\mu < \infty$ and
$(W_t)$ is a strong white noise process with variance $\sigma^2$ and finite
fourth moment (i.e. $\mathbb{E} [W_t^4] < \infty$).
