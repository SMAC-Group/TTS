...
therefore should have the following features @huber2009robust: 
...
Unfortunately such procedures cannot replace robust methods for the following 
reasons @huber2009robust:
...
expressed as an $M$-estimator\footnote{$M$-estimators are obtained as the
...
```{r slmrobex, cache = TRUE, fig.cap="Simulation Study Comparing Robust and Classical Regression Methodologies"}
# Load robust library
library("robustbase")
