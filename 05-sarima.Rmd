...
$$\Theta_p \left({B^S}\right) \theta\left(B\right) X_t = \Theta_Q \left({ B^S }\right) \theta \left({ B }\right) W_t$$
```
...
\begin{align*}
  {X_t} &= \Phi {X_{t - 12}} + {W_t} + \Theta {W_{t - 1}} \hfill \\
